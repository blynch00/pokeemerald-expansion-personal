...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_FOLLOWER_POKEMON_FLAG          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
