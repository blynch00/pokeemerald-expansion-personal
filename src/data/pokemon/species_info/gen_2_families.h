...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_FLASH_FIRE, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_FRISK },
    ...
    [SPECIES_FURRET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ADAPTABILITY , ABILITY_NONE , ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_TINTED_LENS, ABILITY_MINDS_EYE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_IRON_FIST, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_ARIADOS}),
    },
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SNIPER, ABILITY_TOXIC_CHAIN},
        .bodyColor = BODY_COLOR_RED,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_SUDOWOODO, CONDITIONS({IF_KNOWS_MOVE, MOVE_MIMIC})},
                                {EVO_LEVEL, 34, SPECIES_SUDOWOODO}),
    },
#endif //P_GEN_4_CROSS_EVOS
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_FARIGIRAF, CONDITIONS({IF_KNOWS_MOVE, MOVE_TWIN_BEAM})},
                                {EVO_LEVEL, 45, SPECIES_FARIGIRAF}),
    #endif
    },
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CUD_CHEW, ABILITY_ARMOR_TAIL, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_UNAWARE, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_STRONG_JAW, ABILITY_IRON_FIST },
    #else
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STURDY, ABILITY_CONTRARY, ABILITY_SAND_STREAM },
    #else
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_KEEN_EYE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_FLAME_BODY, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_RED,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_HUSTLE, ABILITY_REGENERATOR, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GUARD_DOG, ABILITY_FLASH_FIRE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_STURDY, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_SAP_SIPPER, ABILITY_DEFIANT },
    #else
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_SCRAPPY, ABILITY_CUD_CHEW },
    #else
